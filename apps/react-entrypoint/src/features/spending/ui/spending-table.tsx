...
import { Box, Container, Pagination, Table, Text } from "@mantine/core";
        ...
        <Table>
          <Table.Thead>
            <Table.Tr>
              ...
              >
                Month
                <SortIcon field="month" config={sort} />
              </Table.Th>
              <Table.Th
                style={{ cursor: "pointer" }}
              ...
              >
                Year
                <SortIcon field="year" config={sort} />
              </Table.Th>
              <Table.Th
                style={{ cursor: "pointer" }}
              ...
              >
                Total Spent
                <SortIcon field="totalSpent" config={sort} />
              </Table.Th>
              <Table.Th
                style={{ cursor: "pointer" }}
              ...
              >
                Average Amount
                <SortIcon field="averageAmount" config={sort} />
              </Table.Th>
              <Table.Th
                style={{ cursor: "pointer" }}
              ...
              >
                Expenses
                <SortIcon field="expenseCount" config={sort} />
              </Table.Th>
            </Table.Tr>
          </Table.Thead>
