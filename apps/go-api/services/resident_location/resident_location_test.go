...
func (m *mockRepo) List(ctx context.Context, limit, offset int) ([]*resident_location.ResidentLocation, error) {
	args := m.Called(ctx, limit, offset)
	return args.Get(0).([]*resident_location.ResidentLocation), args.Error(1)
}

func (m *mockRepo) Create(ctx context.Context, input *resident_location.ResidentLocationInput) (*resident_location.ResidentLocation, error) {
	args := m.Called(ctx, input)
	return args.Get(0).(*resident_location.ResidentLocation), args.Error(1)
}

func (m *mockRepo) Update(ctx context.Context, id int64, input *resident_location.ResidentLocationInput) (*resident_location.ResidentLocation, error) {
...
func TestService_List(t *testing.T) {
	...
	now := time.Now()
	loc1 := resident_location.NewResidentLocation(1, "USA", "NYC", "10001", "Main St", "10", "1A", now, now)
	loc2 := resident_location.NewResidentLocation(2, "USA", "LA", "90001", "Sunset Blvd", "20", "2B", now, now)
...
func TestService_Create(t *testing.T) {
	...
	expected := resident_location.NewResidentLocation(1, "USA", "NYC", "10001", "Main St", "10", "1A", now, now)
...
func TestService_Update(t *testing.T) {
	...
	expected := resident_location.NewResidentLocation(1, "Canada", "Toronto", "M5A", "Bay St", "100", "3C", now, now)
